...
fn roundtrip_mgh09_rational() {
    ...
    let built = FitGraphBuilder::new()
        .add_mgh09_rational("mgh09", 1.9280693458e-01, 1.9128232873e-01, 1.2305650693e-01, 1.3606233068e-01)
        .build();
    let hand = hand_spec(
        "mgh09",
...
fn builder_preserves_float_values_exactly() {
    ...
    let actual = spec.nodes[0].parameters.get("c").expect("c parameter present").value;
