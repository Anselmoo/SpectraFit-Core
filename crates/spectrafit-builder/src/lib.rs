...
impl FitGraphBuilder {
    ...
    pub fn add_quadratic(self, id: &str, amplitude: f64, center: f64, offset: f64) -> Self {
        self.add_node(id, ModelTypeStr::Quadratic, &[amplitude, center, offset])
    }
    ...
    pub fn add_double_exponential(self, id: &str, a1: f64, lam1: f64, a2: f64, lam2: f64) -> Self {
        self.add_node(id, ModelTypeStr::DoubleExponential, &[a1, lam1, a2, lam2])
    }
    ...
    pub fn add_pearson7(self, id: &str, amplitude: f64, center: f64, sigma: f64, m: f64) -> Self {
        self.add_node(id, ModelTypeStr::Pearson7, &[amplitude, center, sigma, m])
    }
    ...
    pub fn add_moffat(self, id: &str, amplitude: f64, center: f64, sigma: f64, beta: f64) -> Self {
        self.add_node(id, ModelTypeStr::Moffat, &[amplitude, center, sigma, beta])
    }
    ...
    pub fn add_students_t(
        ...
        self.add_node(id, ModelTypeStr::StudentsT, &[amplitude, center, sigma, nu])
    }
    ...
    /// Parameters (in order): `amplitude`, `center`, `sigma_l`, `sigma_r`,
    /// `m_l`, `m_r`.
    // Allowed: mirrors the kernel's declared `param_names()` positionally —
    // amplitude, center, sigma_l, sigma_r, m_l, m_r — splitting into a struct
    // would just rename the same six-parameter bundle.
    ...
    pub fn add_asym_ir(self, id: &str, amplitude: f64, center: f64, sigma: f64, k: f64) -> Self {
        self.add_node(id, ModelTypeStr::AsymIr, &[amplitude, center, sigma, k])
    }
...
const ALL_MODELS: &[ModelTypeStr] = &[
    ...
    ModelTypeStr::PowerLawOffset,
    ModelTypeStr::Mgh09Rational,
    ModelTypeStr::RationalCubic,
    ModelTypeStr::GeneralisedLogistic,
    ModelTypeStr::ExpOverLinear,
];
