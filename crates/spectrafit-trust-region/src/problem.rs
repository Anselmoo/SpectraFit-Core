...
/// * Bounds reflection and tied-parameter application live in
///   [`set_params`](TrustRegionProblem::set_params);
...
pub trait TrustRegionProblem {
    ...
    ///
    /// Called after [`set_params`](Self::set_params) so the driver can read back
    ...
    /// [`params`](Self::params) may differ from `p`.
    ...
    /// [`apply_jacobian`](Self::apply_jacobian): no driver calls it today and
