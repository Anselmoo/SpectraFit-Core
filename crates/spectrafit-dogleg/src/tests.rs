//! Convergence tests for the dogleg method on synthetic problems.
...
#[test]
fn dogleg_recovers_linear_least_squares() {
    // Overdetermined consistent system: true x = [2, -1].
...
#[test]
fn dogleg_converges_on_rosenbrock() {
