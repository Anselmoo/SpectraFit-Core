...
mod tests {
    ...
    use spectrafit_types::{FitGraphSpec, FitOptionsSpec, MeasurementSpec, ModelNodeSpec, ModelTypeStr, ParameterSpec};
    ...
    fn solve_varpro_multi_dataset_produces_slices() {
        ...
        let options = FitOptionsSpec::default();
        let result =
            solve_varpro(&graph, &[make_ds("ds1"), make_ds("ds2")], &params_map, &options)
