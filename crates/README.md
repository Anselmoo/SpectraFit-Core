...
| `spectrafit-solver` | `crates/spectrafit-solver` | Strategy dispatch (`lm` = faer default, `lm-legacy`, `trf`, `geodesic`, `dogleg`, `newton-cg`, `irls`, `global`/DE, `varpro`, `auto`); post-fit statistics (chi², AIC, BIC, covariance) |
