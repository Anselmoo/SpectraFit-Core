...
//!
//! [`GraphError`] is defined as the typed error shape we INTEND to use at
//! API boundaries. Today, public functions still return
//! `Result<_, CoreError>` — the conversion remains a follow-up, not yet
//! done. New code that needs structured graph error reporting
