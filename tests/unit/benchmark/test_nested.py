...
def test_nested_adequacy_i1_corner_case_reduced_wins_bic_argmin():
    ...
    """
    result = nested_adequacy(
        true_order=3, fit_order=_i1_corner_case_fit_order, n=100
    )
    ...
    assert result.over_not_preferred_bic is True, "BIC pairwise: over-model not preferred"
