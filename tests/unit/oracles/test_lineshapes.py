...
Covers all 23 registered lineshape builders: unit tests for
...
# All 23 lineshape recipes and their correct test variants.
...
@pytest.mark.parametrize(
    ("recipe", "variant"),
    _LINESHAPE_PARAMS,
    ids=[p[0] for p in _LINESHAPE_PARAMS],
)
...
def test_registry_contains_all_expected_keys() -> None:
    """Test that the registry has exactly the 23 expected lineshape keys."""
