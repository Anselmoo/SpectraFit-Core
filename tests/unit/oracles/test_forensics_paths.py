...
class _RaisingBackend(Backend):
    ...
    def build(self, case: Any) -> Any:
        raise NotImplementedError

    def run(self, model: Any, case: Any) -> Any:
        raise NotImplementedError

    def extract(self, raw: Any, case: Any) -> BackendOutcome:
        raise NotImplementedError

    def fit(self, case: Any, n_reps: int = 1) -> BackendOutcome:
