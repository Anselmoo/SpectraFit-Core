...
def test_all_has_expected_count() -> None:
    """__all__ must list exactly 19 symbols — catches accidental growth or deletion.
    ...
    """
    assert len(_ALL) == 19, f"Expected 19 symbols in __all__, got {len(_ALL)}: {sorted(_ALL)}"
