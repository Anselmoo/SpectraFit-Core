...
def test_all_has_expected_count() -> None:
    """__all__ must list exactly 20 symbols — catches accidental growth or deletion.
    ...
    """
    assert len(_ALL) == 20, f"Expected 20 symbols in __all__, got {len(_ALL)}: {sorted(_ALL)}"
