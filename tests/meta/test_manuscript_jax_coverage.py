...
UPDATED 2026-09-09: the catalog grew 154 -> 160 (130 -> 136 jax-eligible) with the
`robust` category (six IRLS-on-contaminated-Gaussian cases; the Gaussian has a jax
kernel, so all six are jax-eligible). The manuscript prose below is still the
older text.
