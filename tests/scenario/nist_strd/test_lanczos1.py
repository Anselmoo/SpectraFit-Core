...
def test_lanczos1_recovers_nist_certified_parameters_start1() -> None:
    ...
    assert result.success is True, f"Lanczos1 (start1) did not converge: {result.message}"
...
def test_lanczos1_recovers_nist_certified_parameters_start2() -> None:
    ...
    assert result.success is True, f"Lanczos1 (start2) did not converge: {result.message}"
