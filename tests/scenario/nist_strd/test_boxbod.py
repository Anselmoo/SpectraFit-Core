...
def test_boxbod_recovers_nist_certified_parameters_start2() -> None:
    ...
    assert rel_b1 < 1e-3, (
        f"b1 (start2): recovered {b1_recovered:.6e}, certified {b1_cert:.6e}, rel {rel_b1:.2e}"
    )
    assert rel_b2 < 1e-3, (
        f"b2 (start2): recovered {b2_recovered:.6e}, certified {b2_cert:.6e}, rel {rel_b2:.2e}"
    )
...
def test_boxbod_reduced_chi2_and_dof() -> None:
    ...
    assert result.dof == DOF, f"DOF mismatch: spectrafit reports {result.dof}, expected {DOF}"
...
def test_boxbod_recovers_nist_certified_parameters_start1() -> None:
    ...
    assert rel_b1 < 1e-3, (
        f"b1 (start1): recovered {b1_recovered:.6e}, certified {b1_cert:.6e}, rel {rel_b1:.2e}"
    )
    assert rel_b2 < 1e-3, (
        f"b2 (start1): recovered {b2_recovered:.6e}, certified {b2_cert:.6e}, rel {rel_b2:.2e}"
    )
