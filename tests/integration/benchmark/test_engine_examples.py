...
def _outcome(aic: float, *, bic: float = 0.0) -> BackendOutcome:
    ...
    o = _O()
    o.aic = aic  # ty: ignore[unresolved-attribute]  # dynamic attribute on a minimal stand-in class
    o.bic = bic  # ty: ignore[unresolved-attribute]  # dynamic attribute on a minimal stand-in class
