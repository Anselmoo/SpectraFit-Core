...
from oracles.audit.wires import ALL_WIRES, wire_w10_sigma_calibration, wire_w11_speed_inference
...
def test_w11_pass_when_speed_passed_true() -> None:
    ...
    evidence_lower = r.evidence.lower()
    assert "speedup" in evidence_lower or "geomean" in evidence_lower or "ci" in evidence_lower
