...
import pytest
from oracles.trust_ledger import CredibilityRung, TrustBlock
...
_NIST_DATASET_Gauss1 = {
    ...
    "n_params": 8,
    "params": [
        {"name": "b1", "certified": 98.0, "fitted": 98.0, "sig_figs_agreed": 6.0},
    ],
    "min_sig_figs": 6.0,
    "passed": True,
}
...
_RUNG5_PAYLOAD: dict[str, Any] = {
    ...
    "inference": {
        "cases": [
            {"caseId": "EZ-001", "speedupCi": [5.0, 10.0], "deltaR2Ci": [0.0, 0.001]},
        ],
        "equivalence": [
            {"category": "easy", "equivalent": True, "margin": 0.1, "diff": 0.01},
        ],
    },
}
