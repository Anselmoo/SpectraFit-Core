...
def test_gaussian_peak_value_equals_amplitude_at_center(
    a: float, c: float, s: float
) -> None:
...
def test_added_noise_has_zero_mean_and_unit_variance(
    sigma: float, n: int, seed: int
) -> None:
