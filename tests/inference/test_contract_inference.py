...
def test_case_inference_round_trips_camelcase():
    ci = CaseInference(case_id="EZ-001", speedup_ci=CI(lo=8.0, point=10.0, hi=12.0),
...
def test_inference_config_is_preregistered():
    cfg = InferenceConfig(equivalence_margin=1e-3, bootstrap_b=2000,
                          seed=20260612, fdr_q=0.05)
