...
const report = {
  ...
  trustBlock: { nClaimsAudited: 15, nClaimsTotal: 21, rung: 5, wires: [] },
} as unknown as BenchReport;

describe("Methods rigor — we don't cherry-pick (body function direct import)", () => {
  it("composes the resampling / interval / disclosed-gaps figures from the contract", () => {
...
describe("Methods rigor — reproduce affordance (body function direct import)", () => {
  it("shows the spc-bench command and the pinned run provenance", () => {
