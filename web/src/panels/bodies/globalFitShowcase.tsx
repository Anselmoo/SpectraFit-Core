  ...
  return (
    <>
      ...
      >
        ...
        <span style={{ color: "var(--text-secondary)" }}>Shared peaks</span>
        <span>
          {gf.traces
      ...
      <PlotMount
        make={(w) => globalFitSlicesPlot(gf, { width: w })}
        deps={[report]}
        title={PLOT_SPECS["global-fit-slices"].question}
      />
      <PlotMount
        make={(w) => globalFitKineticsPlot(gf, { width: w })}
        deps={[report]}
        title={PLOT_SPECS["global-fit-kinetics"].question}
      />
