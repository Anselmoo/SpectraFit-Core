...
const SAMPLE_WIRES = [
  { wire_id: "W1", name: "Synth invariants", status: "pass", evidence: "all pass" },
  { wire_id: "W2a", name: "Metric formulas", status: "pass", evidence: "r² recomputed" },
  { wire_id: "W2c", name: "κ(J) conditioning", status: "gap", evidence: "lmfit does not expose κ(J)" },
  { wire_id: "W3", name: "Contract roundtrip", status: "pass", evidence: "JSON roundtrip clean" },
  { wire_id: "W5", name: "Render fidelity", status: "skipped", evidence: "Playwright JSON-vs-render (CI only)" },
  { wire_id: "W6", name: "Gate values", status: "pass", evidence: "geomean speedup ≥ 1×" },
