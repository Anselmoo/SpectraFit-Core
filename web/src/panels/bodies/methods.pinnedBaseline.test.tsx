...
describe("pinnedBaselineCard — gated-on-data", () => {
  it("returns null when manifest.pinned is null", () => {
...
describe("pinnedBaselineCard — renders comparison", () => {
  ...
  it("renders pinned geomean speedup value", () => {
    const node = pinnedBaselineCard(reportWithPinned);
    const { container } = render(node as ReactElement);
  ...
  it("renders current geomean speedup value", () => {
    const node = pinnedBaselineCard(reportWithPinned);
    const { container } = render(node as ReactElement);
  ...
  it("renders the delta (current − pinned)", () => {
  ...
  it("is subject-blind — does not hardcode a backend name", () => {
    const node = pinnedBaselineCard(reportWithPinned);
    const { container } = render(node as ReactElement);
  ...
  it("renders an up/down/flat indicator for positive delta", () => {
