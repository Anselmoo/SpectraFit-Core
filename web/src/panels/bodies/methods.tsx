...
function NistValidationCard({
  ...
  nv: NonNullable<NonNullable<BenchReport["trustBlock"]>["nistValidation"]>;
}): ReactNode {
                  ...
                  <tr style={{ borderBottom: "1px solid var(--hairline)" }}>
                    ...
                    <td
                      style={{
                        padding: "var(--s2) var(--s3)",
                        textAlign: "center",
                        color: ds.minSigFigs >= nv.thresholdSigFigs ? "var(--pass)" : "var(--fail)",
                        fontWeight: 600,
                      }}
                    >
                    ...
                    >
                      ...
                      <td
                        style={{
                          ...
                          textAlign: "center",
                          fontSize: "0.72rem",
                          color: p.sigFigsAgreed >= nv.thresholdSigFigs ? "var(--pass)" : "var(--warn)",
                        }}
                      >
