  ...
  return (
    <Fragment>
      <tr style={{ borderBottom: "1px solid var(--hairline)" }}>
        ...
        <td style={{ padding: "var(--s2) var(--s3)", textAlign: "center" }}>{ds.nParams}</td>
        <td
          style={{
            padding: "var(--s2) var(--s3)",
            textAlign: "center",
            color: ds.minSigFigs >= thresholdSigFigs ? "var(--pass)" : "var(--fail)",
            fontWeight: 600,
          }}
        >
          {ds.minSigFigs.toFixed(2)}
        </td>
        <td style={{ padding: "var(--s2) var(--s3)", textAlign: "center" }}><PassIcon passed={ds.passed} /></td>
      </tr>
      {ds.params.map((p) => (
        <tr
          key={`${ds.name}-${p.name}`}
        ...
        >
          ...
          <td
            style={{
              ...
              textAlign: "center",
              fontSize: "0.72rem",
              color: p.sigFigsAgreed >= thresholdSigFigs ? "var(--pass)" : "var(--warn)",
            }}
          >
