  ...
  datasets: [
    {
      ...
      passed: true,
      params: [
        { name: "b1", certified: 98.7782, fitted: 98.7782, sig_figs_agreed: 11.25 },
        { name: "b2", certified: 0.0104973, fitted: 0.0104973, sig_figs_agreed: 10.82 },
      ],
    },
    {
      name: "Lanczos1",
      ...
      passed: true,
      params: [
        { name: "b1", certified: 0.0951, fitted: 0.0951, sig_figs_agreed: 8.75 },
      ],
    },
  ],
};
...
describe("nist-validation panel (body function — audit destination removed)", () => {
  ...
  test("renders gracefully when nist_validation is null", () => {
