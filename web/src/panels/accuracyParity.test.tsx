...
describe("Accuracy parity by category (T5.1)", () => {
  it("takeaway counts the equivalent categories and names the baseline", () => {
  ...
  it("surfaces the one category that is NOT at parity, by label", () => {
    const text = renderPanel("accuracy-parity");
  ...
  it("optfn non-equivalence is framed as out-of-gate-scope, not as accuracy exception", () => {
    const text = renderPanel("accuracy-parity");
