...
export interface components {
    schemas: {
        ...
        BackendProfile: {
             ...
             * @description κ(J) at convergence. Structural property of the case, not the solver. κ ≥ 1e6 → ill-conditioned (explains backend disagreement); κ ≤ 1e4 → well-posed. Carried through BackendOutcome; backends that don't expose a Jacobian leave this None (scipy-ls backends populate it from raw.jac).
             */
        ...
        BenchReport: {
            ...
            /** @description Manifest headline numbers (mirrors `reports._headline`) — exposed so the web gate-state UI can render geomean / max |Δr²| / win-rate / pinned ratio without a sidecar fetch. Additive 1.1 -> 1.2 bump; old payloads on disk validate against the bumped schema because Pydantic fills the default. */
        ...
        /**
         * MultiDim
         * @description Genuinely N-dimensional ($\ge$3-D) fit showcase (SP-2).
         *
        ...
        /**
         * Uncertainty
         * @description Parameter-pull diagnostics: pulls = $(\mathrm{est}-\mathrm{truth})/\sigma$, coverage, reported $\sigma$.
         *
