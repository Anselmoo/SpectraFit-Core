  ...
  return toSvg(
    Plot.plot({
      ...
      marks: [
        ...
        Plot.line(s.envelope, { x: "x", y: "y", stroke: "var(--text-primary)", strokeWidth: 1.5, strokeOpacity: 0.7 }),
        Plot.dot(s.envelope, { x: "x", y: "y", stroke: "var(--text-primary)", fill: "var(--text-primary)", r: 3.5 }),
      ],
    })
  );
}
