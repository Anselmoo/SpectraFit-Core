    ...
    Plot.plot({
      ...
      marks: [
        ...
        Plot.text(
          ...
          { frameAnchor: "top-right", fill: "var(--text-secondary)", fontSize: 9, fontStyle: "italic", dy: 4 },
        ),
      ],
    }),
  );
    ...
    Plot.plot({
      ...
      marks: [
        ...
        Plot.text(
          ...
          { x: "t", y: "amplitude", text: "peak", fill: "var(--text-secondary)", fontSize: 9, dx: 6, textAnchor: "start" },
        ),
      ],
    }),
  );
