    ...
    >
      <span>
        ...
        {fastestId != null && (
          <>
            {" · "}fastest:{" "}
            <strong style={{ color: "var(--text-primary)" }}>{labelMap[fastestId] ?? fastestId}</strong>
        ...
        {spread != null && (
          <>
            {" · "}r² spread{" "}
            <strong style={{ color: "var(--text-primary)" }}>{spread.toExponential(2)}</strong>
          </>
        )}
        {absentIds.length > 0 && (
          <span style={{ color: "var(--text-secondary)" }}>
            {" · "}
            <strong style={{ color: "var(--text-secondary)" }}>{absentIds.join(", ")}</strong>{" "}
