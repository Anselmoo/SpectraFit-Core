...
export function EvidenceOverview({
  ...
  return (
    <Fragment key="ev-overview">
      {/* S6: was <h2> with no <h1> anywhere in this view — the page had no
          top-level heading at all. Promoted to <h1>; the section headings
          below move from <h3> to <h2> in the same fix so the hierarchy
          doesn't skip a level (.ev-section styling is class-based, not
          tag-based, so this is a pure semantics change). */}
      <h1
        style={{
          margin: 0,
      ...
      <section id="sec-finding">
        <h2 className="ev-section">The finding</h2>
      ...
      <section id="sec-compare">
        <h2 className="ev-section">Across all cases</h2>
      ...
      <section id="sec-constrained">
        <h2 className="ev-section">Constrained fitting</h2>
      ...
      <section id="sec-showcase">
        <h2 className="ev-section">Native showcases</h2>
