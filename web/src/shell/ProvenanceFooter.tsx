...
export function ProvenanceFooter({ report }: { report: BenchReport }): ReactElement | null {
  ...
  const gitCommit: string | null = report.gitCommit ?? null;
  const gitBranch: string | null = report.gitBranch ?? null;
  const runTimestampUnix: number | null = report.runTimestampUnix ?? null;
