...
export const CONTRACT_LEAVES: string[] = [
  ...
  "trustBlock.rung",
  "trustBlock.wires[].wire_id",
  "trustBlock.wires[].name",
  "trustBlock.wires[].status",
  "trustBlock.wires[].evidence",
  "trustBlock.wires[].details",
  "trustBlock.n_claims_audited",
  "trustBlock.n_claims_total",
  "trustBlock.nist_validation.threshold_sig_figs",
  "trustBlock.nist_validation.datasets[].name",
  "trustBlock.nist_validation.datasets[].model",
  "trustBlock.nist_validation.datasets[].n_params",
  "trustBlock.nist_validation.datasets[].params[].name",
  "trustBlock.nist_validation.datasets[].params[].certified",
  "trustBlock.nist_validation.datasets[].params[].fitted",
  "trustBlock.nist_validation.datasets[].params[].sig_figs_agreed",
  "trustBlock.nist_validation.datasets[].min_sig_figs",
  "trustBlock.nist_validation.datasets[].passed",
  "trustBlock.nist_validation.min_sig_figs",
  "trustBlock.nist_validation.passed",
...
export const COVERAGE: Record<string, string> = {
  ...
  "trustBlock.wires[].wire_id": "ignored:ledger-only (wire matrix removed with Audit UI; available via /api/v1/trust)",
  ...
  "trustBlock.n_claims_audited": "rendered:panels/bodies/standing renderTruthCard (claims-audited count in scope card)",
  "trustBlock.n_claims_total": "rendered:panels/bodies/standing renderTruthCard (claims-total in scope card)",
  "trustBlock.nist_validation.threshold_sig_figs": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].name": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].model": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].n_params": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].params[].name": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].params[].certified": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].params[].fitted": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].params[].sig_figs_agreed": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].min_sig_figs": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.datasets[].passed": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.min_sig_figs": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
  "trustBlock.nist_validation.passed": "ignored:ledger-only (NIST table removed with Audit UI; available via /api/v1/trust)",
...
describe("contract coverage manifest", () => {
  ...
  it("trustBlock claims-count leaves are classified as rendered (not ignored)", () => {
    expect(COVERAGE["trustBlock.n_claims_audited"]).toMatch(/^rendered:/);
    expect(COVERAGE["trustBlock.n_claims_total"]).toMatch(/^rendered:/);
  });
