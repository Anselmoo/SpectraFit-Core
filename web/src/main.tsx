...
import { loadReport, assertSupported } from "./contract";
...
function App() {
  ...
  if (state.status === "loading") {
    return (
      ...
      >
        <div className="glass" style={{ padding: "var(--space-6)", color: "var(--text-secondary)" }}>
          Loading report…
        </div>
      </div>
    );
    ...
    return (
      ...
      >
        ...
        >
          ...
          <p style={{ margin: "var(--space-3) 0 0", fontSize: "0.8rem", color: "var(--text-secondary)" }}>
