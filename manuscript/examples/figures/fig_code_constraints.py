...
Builds ``fig_code_constraints.tex`` into the vector PDF used for submission
...
Outputs (written next to this file):
    fig_code_constraints.pdf   vector, for submission
    fig_code_constraints.png   300 dpi raster, for preview
...
The calls in this listing are the ones
``manuscript/examples/fecl4/fecl4_constraint_scenarios.py`` actually makes; the
table beside it in the manuscript is that script's output. A change to either
invalidates the listing until both are re-run.
"""
