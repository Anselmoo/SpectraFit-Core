"""Figure: Listing 3, the commands that run the benchmark suite.

Builds ``fig_code_benchmark.tex`` into the vector PDF used for submission
...
Outputs (written next to this file):
    fig_code_benchmark.pdf   vector, for submission
    fig_code_benchmark.png   300 dpi raster, for preview
...
The two caveats baked into the listing -- the release-build requirement and the
halved repetition count -- are comments on the commands they qualify rather than
prose after the block, because a reader recomputing the reported figures meets
them at the command line, not in a paragraph.
"""
