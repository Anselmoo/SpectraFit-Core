...
case study reproduced as Figure 3 of the software metapaper.
...
| `fig_constraint_grid.py` | Renders Figure 3: both spectra under four constraint hypotheses, with residuals |
| `fecl4_constraint_scenarios.py` | Fits the four hypotheses and writes `fecl4_constraint_scenarios.json` (Table 2) |
| `fecl4_constraint_scenarios.json` | Per-scenario free parameters, iterations, timings, r^2 and reduced chi-squared |
