...
The spectrafit-core Rust workspace is organized into 11 composable crates with a strict downward dependency hierarchy. For full generated Rust API documentation, see the project's [generated rustdoc — built via `cargo doc --workspace --no-deps`](../../../).
