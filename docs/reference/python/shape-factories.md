...
description: The 36 shape-factory functions in spectrafit_core.compose used to build a fit graph declaratively, from peak shapes to baselines and steps.
tags:
  - Models
  - Python
---
...
`spectrafit_core.compose` exposes 36 shape-factory functions used to build a
...
::: spectrafit_core.compose.rational_cubic
::: spectrafit_core.compose.generalised_logistic
::: spectrafit_core.compose.exp_over_linear
