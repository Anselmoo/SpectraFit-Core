...
``bounded_fitting.py``, ``robust_fitting.py``, ``global_optimizer.py``) is a
...
# bounded_fitting -> robust_fitting -> global_optimizer); not load-bearing,
# just readable in log output.
SCRIPTS: tuple[str, ...] = (
    "fitting.py",
    "3d_fitting.py",
    "multi_dataset_1d.py",
