...
The catalog has grown well past an initial handful — see the
[model reference](../reference/models/index.md) for the full, authoritative formula table (canonical
