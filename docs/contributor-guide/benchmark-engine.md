---
icon: lucide/cpu
description: python/oracles/ — the benchmark and cross-verification harness that compares spectrafit against lmfit and jax/optimistix oracles across a deterministic case catalog.
---
