...
bound scaling ([Coleman & Li, 1996](#references)).
...
([Transtrum & Sethna, 2012](#references)) adds a second-order correction
...
cheap** → use **`"dogleg"`** (Powell's dogleg trust-region method,
[Powell, 1970](#references)). It interpolates between the Gauss-Newton and
...
Newton-CG (Steihaug-Toint truncated conjugate gradients,
[Steihaug, 1983](#references); [Toint, 1981](#references)) method never
...
- Coleman, T.F. & Li, Y. (1996). "An interior trust region approach for
  ...
  6(2), 418–445.
- Powell, M.J.D. (1970). "A new algorithm for unconstrained optimization."
...
- Steihaug, T. (1983). "The conjugate gradient method and trust regions in
  ...
  626–637.
- Toint, Ph. L. (1981). "Towards an efficient sparsity exploiting Newton
  method for minimization." In *Sparse Matrices and Their Uses* (Duff, ed.),
  Academic Press, 57–88.
- Transtrum, M.K. & Sethna, J.P. (2012). "Geodesic acceleration and the
