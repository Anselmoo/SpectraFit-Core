...
def _theta_distance_to_truth(o: BackendOutcome, case: BenchCase) -> list[float] | None:
    r"""Scale-normalized per-iteration distance of $\theta$ to the synthetic ground truth.
...
def _summary(
    ...
    r"""Build the headline KPI block; $\Delta$AIC/$\Delta$BIC are vs the best solver in the run."""
