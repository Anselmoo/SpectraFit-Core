...
def wire_w2a_metric_identity(
    ...
    r"""W2a: recompute $r^2$/rmse/reduced-$\chi^2$ and compare to stored.
...
def wire_w2c_jacobian_kappa(
    ...
    r"""W2c: verify Jacobian conditioning $\kappa(J)$ per (case, backend).
...
def _w8_resolve_validation(
    ...
    except Exception as exc:  # noqa: BLE001 - defensive: missing build/fixtures  # pragma: no cover
