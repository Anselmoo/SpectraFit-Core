...
def _load_nist_validation() -> NistValidation | None:
    ...
    except Exception:  # noqa: BLE001 pragma: no cover - defensive: missing build/fixtures
        return None
...
def _load_nested_adequacy(results_path: Path) -> NestedAdequacy | None:
    ...
    try:
        ...
        return None
    except Exception:  # noqa: BLE001 pragma: no cover - defensive: parse error / missing build
        return None
