...
"""Info:
    NIST-published starting guess (5 free params).
...
r"""Info:
    Certified parameter values + 1$\sigma$ standard errors (verbatim from NIST .dat file).

Warning:
    Values are copied verbatim from NIST's published .dat file -- do
    not round when comparing against a fitted result.
"""
...
"""Info:
    33 (x, y) observations — NIST file has columns (y, x); reordered
    here to (x, y).
"""
