...
# Permissive CORS for local dev: the Vite dev server (localhost:5173) and the built
# static app both fetch this API cross-origin. The payload is non-sensitive benchmark
# data, so a wildcard is acceptable here.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
