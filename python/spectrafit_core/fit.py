"""Top-level [`fit`][spectrafit_core.fit] entry point bridging Python contracts to the engine."""
...
def _phase_prepare_arrays(
    ...
    kernel (SP-2), whose dimensionality the Rust compiler infers from the
...
def fit(
    ...
    r"""Run a Levenberg-Marquardt fit and return the result.
