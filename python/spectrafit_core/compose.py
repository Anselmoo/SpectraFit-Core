...
def voigt(id: str, *, dataset_index: int | None = None, **params: ParamKwarg) -> ModelNodeSpec:
...
def fano(id: str, *, dataset_index: int | None = None, **params: ParamKwarg) -> ModelNodeSpec:
...
def tauc(id: str, *, dataset_index: int | None = None, **params: ParamKwarg) -> ModelNodeSpec:
...
def kww(id: str, *, dataset_index: int | None = None, **params: ParamKwarg) -> ModelNodeSpec:
