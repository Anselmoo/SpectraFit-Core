...
description: |
  ...
  superpowers:verification-before-completion. Locate before editing code.
license: MIT
---
...
```
Glob **/Cargo.toml        → manifest discovery
Grep "<ModelName>" crates/ python/ → trace-impact of a removed model
```

For code-touching verification work (writing oracles, harnesses),
Grep/Glob drives the initial location pass before any edit.
