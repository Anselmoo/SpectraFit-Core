...
missing from the map or when any mapped skill path is absent. An agent may be
mapped to the literal sentinel ``(none)`` for a cross-cutting utility agent
with no single-skill owner -- that entry is exempt from the skill-path
existence check.
"""
