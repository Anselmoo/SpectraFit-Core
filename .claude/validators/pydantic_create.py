...
class CreateValidation(BaseModel):
    ...
    def _validate_python_file(self) -> tuple[bool, str]:
    ...
    def _validate_rust_file(self) -> tuple[bool, str]:
    ...
    def _validate_markdown_file(self) -> tuple[bool, str]:
    ...
    def _validate_results_feedback(self) -> tuple[bool, str]:
        """Benchmark feedback: validate required gates and recommendations."""
        try:
            payload = json.loads(self.content)
        except json.JSONDecodeError as exc:
    ...
    def validate_context_specific(self) -> tuple[bool, str]:
        ...
        try:
            ...
            if self.path.endswith(".py"):
                ...
                return self._validate_rust_file()
            elif self.path.endswith(".md"):
                return self._validate_markdown_file()
