...
7. **Routing coverage**: For `.claude/settings.json`, ensure at least one narrowed hook reinforces MCP evidence-source selection (`GitHub MCP`, `Context7`, `fetch_webpage`) before broad exploration.
