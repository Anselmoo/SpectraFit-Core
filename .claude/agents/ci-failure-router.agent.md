...
- If `Grep` would help confirm whether a symbol drift is the root cause (e.g., to verify a field name really was removed), use it before finalising the classification — but do not use it to make edits.
