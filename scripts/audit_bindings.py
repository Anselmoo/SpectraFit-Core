...
rust_binding_audit.md` is an optional, non-gated Markdown rendering of the
same data, regenerated on request via `--write` (see `poe
...
Usage:
    ...
    python scripts/audit_bindings.py --write  # regenerate docs/rust_binding_audit.md
"""
