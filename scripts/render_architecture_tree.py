...
- `analysis/`, `manuscript/` — both excluded from the GitHub mirror publish
  entirely (`pyproject.toml`'s `[tool.rrt.publish_targets.github].exclude`),
  so listing either here is actively wrong on that mirror, not just noise.
